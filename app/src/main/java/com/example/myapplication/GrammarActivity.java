...
public class GrammarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewLessonWidget1 = findViewById(R.id.lesson6);
        ...
        viewLessonWidget1 = findViewById(R.id.lesson7);
        ...
        viewLessonWidget1 = findViewById(R.id.lesson8);
        ...
        viewLessonWidget1 = findViewById(R.id.lesson9);
        ...
        viewLessonWidget1 = findViewById(R.id.lesson10);
        ...
        viewLessonWidget1 = findViewById(R.id.lesson11);
        ...
        viewLessonWidget1 = findViewById(R.id.lesson12);
